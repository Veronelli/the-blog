...
El sistema SHALL dirigir a toda cuenta autenticada que no tenga un perfil público al flujo de creación de perfil antes de concederle acceso al dashboard, independientemente de que tenga privilegios staff o de superusuario. Un usuario autenticado que ya tenga un perfil público SHALL poder acceder al dashboard sin pasar por dicho flujo.
...
- **THEN** el sistema muestra los estilos, componentes y errores de validación propios de Django admin sin cargar una plantilla HTML del proyecto
